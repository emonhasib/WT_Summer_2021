function validateForm() {
    ...
    if (fname == "") {
     document.getElementById("err-fname").innerHTML="Please fill up your name";
      return false;
    }
    if(email == ""){
    ...
    if (pass == "") {
     document.getElementById("err-pass").innerHTML="Please fill out password";
      return false;
        ...
        document.getElementById("err-pass").innerHTML="Password have to be 4 character long";
    }
    ...
    document.getElementById("err-chkbox").innerHTML=" ---Please select one";
        return false;
    }
    if (file == "") {
